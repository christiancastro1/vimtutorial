...
int main()
{
	...
	/* Range of possibilities for a valid answer: {min{a,b}...1} */     //complete Check Practice_TODO

	/* TODO: brute force test for perfect cubes.  Check if             // complete
	 * n = k^3 for some integer k.  */

	/* TODO: write a loop that prints the sum of the first n odd cubes. */ // complete

	/* TODO: write code that gets an integer n from the user and prints out  // complete
	...
	/* TODO: write a program that reads (arbitrarily many) integers from     // complete
