...
/* TODO: write a function that takes 3 integers and returns                            //complete
 * the maximal value */
/* TODO: write a function that takes 3 doubles and returns the                        //complete
 * average value */
/* TODO: write a function that takes two integer parameters and                       //complete
 * swaps the contents, i.e., if x=2 and y=5, then after calling
 * swap(x,y), y=2 and x=5 */
/* TODO: write an isPrime function that takes an integer and returns a boolean        //complete
